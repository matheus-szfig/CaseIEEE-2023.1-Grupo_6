...
export default function MembrosTab () {
  ...
  return (
    <div className='rounded border border-light-gray h-[100%] p-3 shadow-md w-[100%] md:w-2/4 lg:w-2/3 xl:w-3/4 md:me-1 mb-5'>
      ...
      <div className='max-h-[55vh] md:max-h-[70vh] overflow-y-auto border-t mx-4'>
        ...
        {equipeMembros.map((e) => {
          return <MemberComponent key={e.id} nome={e.nome} id={e.id} cargos={e.cargos || []}/>
        })}
        </div>
      </div>
    </div>
