...
import {
  ...
  cargoRemovingAtom,
} from "../profile/ModalRemoveCargos";
import {
  approveCargosModalShowAtom,
  cargoApprovingAtom,
} from "./ModalApproveCargos";
              ...
              >
                ...
                <div>
                  {!c.aprovado ? (
                    <ApproveBtn
                      onClick={(e) =>
                        ApproveCargo(e, id, c.id_equipe, c.id_cargo)
                      }
                      className="mr-2 bg-white hover:bg-gray-300 rounded w-6  font-bold hover:text-white text-primary"
                    />
                  ) : null}
                  <CancelBtn
                    onClick={(e) => RemoveCargo(e, id, c.id_equipe, c.id_cargo)}
                    className="bg-white hover:bg-gray-300 rounded w-6  font-bold hover:text-white text-primary"
                  />
                </div>
              </div>
            );
