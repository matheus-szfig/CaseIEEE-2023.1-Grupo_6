...
const Cadastro = () => {
  ...
  function verificaConteudoSelect(){
    ...
    else if((equipe3.value!=="" && cargo3.value==="") || (cargo3.value!=="" && equipe3.value==="")){
            ...
            <section className="w-full h-[84%]">
              ...
              <div className='mt-3'>
                <div className="inline-block w-1/2 h-full pr-2">
                  ...
                  <InputSenhas onChange={(event) => handleChange(event, setSenha)} 
                    type={showPassword ? "text" : "password"} 
                    name={"senhaUsuario"} 
                    id={"senhaInput"}
                    placeholder={showPassword ? "exemploDeSenha4567" : "******************"} 
                    onClick={handlePasswordToggle}
                    content={showPassword ? ( <img className="h-6" src={process.env.PUBLIC_URL + "/Visibility.svg"} alt="Show Password"/>) : (<img className="h-6" src={process.env.PUBLIC_URL + "/VisibilityOff.svg"} alt="Hide Password"/> )}
                  />
                </div>
                ...
                <div className="inline-block w-1/2 h-full pl-2">
                  ...
                  <InputSenhas onChange={(event) => handleChange(event, setSenhaConfirmacao)} 
                    type={showPassword ? "text" : "password"} 
                    name={"SenhaUsuario"} 
                    id={"senhaConfInput"}
                    placeholder={showPassword ? "exemploDeSenha4567" : "******************"} 
              ...
              <div className='mt-3'>
                 <div className="inline-block w-1/2 h-full pr-2">
                  ...
                  <SelectEquipe disabled={false} id={"e1Select"} name={"equipe1"} onChange={(event) => handleChangeSelect(event, setEquipe1)}/>
                 </div>
                  
                 <div className="inline-block w-1/2 h-full pl-2">
                   <label for="c1Select" className='text-blue-500 font-medium text-lg'>Primeiro Cargo<span className='text-[#F81818]'>*</span> </label>
                   <SelectCargo disabled={false} id={"c1Select"} name={"cargo1"} onChange={(event) => handleChangeSelect(event, setCargo1)}/>
                 </div>
             </div>
             ...
             <div className='mt-4'>
                 <div className="inline-block w-1/2 h-full pr-2">
                  ...
                  <SelectEquipe disabled={verificador} id={"e2Select"} name={"equipe2"} onChange={(event) => handleChangeSelect(event, setEquipe2)}/>
                 </div>
                  
                 <div className="inline-block w-1/2 h-full pl-2">
                   <label for="c2Select" className='text-blue-500 font-medium text-lg'>Segundo Cargo</label>
                   <SelectCargo disabled={verificador} id={"c2Select"} name={"cargo2"} onChange={(event) => handleChangeSelect(event, setCargo2)}/>
                 </div>
             </div>
             ...
             <div className='mt-4'>
                 <div className="inline-block w-1/2 h-full pr-2">
                  ...
                  <SelectEquipe disabled={verificador2} id={"e3Select"} name={"equipe3"} onChange={(event) => handleChangeSelect(event, setEquipe3)}/>
                 </div>
                  
                 <div className="inline-block w-1/2 h-full pl-2">
                   <label for="c3Select" className='text-blue-500 font-medium text-lg'>Terceiro Cargo</label>
                   <SelectCargo disabled={verificador2} id={"c3Select"} name={"cargo3"} onChange={(event) => handleChangeSelect(event, setCargo3)}/>
                 </div>
             </div>
            </section>
